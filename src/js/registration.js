...
export default function registration() {
  ...
  document.querySelector('.registration .change-form a');
  const registrationForm = document.querySelector('.registration .form');

  const loginFormHandler = () => {
    document.querySelector('.registration-login.registration')
        .style.display = 'none';
  ...
  const checkRegistration = (e) => {
    ...
    const checkPasswordConfirm =
        document.querySelector('#user-password-confirm');
    const alertError =
        document.querySelector('.registration .alert-error-hide');
    ...
    const password =
        document.querySelector('#user-password-registration').value;
